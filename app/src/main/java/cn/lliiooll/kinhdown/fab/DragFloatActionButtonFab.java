...
public class DragFloatActionButtonFab extends FloatingActionButton {
    private int parentHeight;
    private int parentWidth;
    private int slop;


    public DragFloatActionButtonFab(Context context) {
        this(context, null);
    }


    public DragFloatActionButtonFab(Context context, AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public DragFloatActionButtonFab(Context context, AttributeSet attrs, int defStyleAttr) {
