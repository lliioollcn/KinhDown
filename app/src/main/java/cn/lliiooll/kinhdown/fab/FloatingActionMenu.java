...
public class FloatingActionMenu extends ViewGroup {
    ...
    private DragFloatActionButtonFab mMenuButton;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mMenuFabSize = attr.getInt(com.github.clans.fab.R.styleable.FloatingActionMenu_menu_fab_size, DragFloatActionButtonFab.SIZE_NORMAL);
    ...
    private void createMenuButton() {
        mMenuButton = new DragFloatActionButtonFab(getContext());
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = mButtonsCount - 1; i >= 0; i--) {
            ...
            DragFloatActionButtonFab fab = (DragFloatActionButtonFab) child;
    ...
    private void createLabels() {
        for (int i = 0; i < mButtonsCount; i++) {
            ...
            final DragFloatActionButtonFab fab = (DragFloatActionButtonFab) getChildAt(i);
    ...
    private void addLabel(DragFloatActionButtonFab fab) {
    ...
    public void open(final boolean animate) {
        if (!isOpened()) {
            ...
            for (int i = getChildCount() - 1; i >= 0; i--) {
                View child = getChildAt(i);
                if (child instanceof DragFloatActionButtonFab && child.getVisibility() != GONE) {
                    counter++;

                    final DragFloatActionButtonFab fab = (DragFloatActionButtonFab) child;
    ...
    /**
     * Makes the {@link DragFloatActionButtonFab} to appear inside the {@link #FloatingActionMenu} and
    ...
    /**
     * Makes the {@link DragFloatActionButtonFab} to disappear inside the {@link #FloatingActionMenu} and
    ...
    public void addMenuButton(DragFloatActionButtonFab fab) {
        addView(fab, mButtonsCount - 2);
        mButtonsCount++;
        addLabel(fab);
    }

    public void removeMenuButton(DragFloatActionButtonFab fab) {
        removeView(fab.getLabelView());
        removeView(fab);
        mButtonsCount--;
    }

    public void addMenuButton(DragFloatActionButtonFab fab, int index) {
    ...
    public void removeAllMenuButtons() {
        ...
        List<DragFloatActionButtonFab> viewsToRemove = new ArrayList<>();
        for (int i = 0; i < getChildCount(); i++) {
            View v = getChildAt(i);
            if (v != mMenuButton && v != mImageToggle && v instanceof DragFloatActionButtonFab) {
                viewsToRemove.add((DragFloatActionButtonFab) v);
            }
        }
        for (DragFloatActionButtonFab v : viewsToRemove) {
            removeMenuButton(v);
        }
    }
